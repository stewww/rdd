 ...
 *
 *  ---General example of run_time class---
 *  run_time myClass; //declare class
 *  ...
 ...
 *  //now print_..._run_time() and get_..._run_time() are available.
 *
 *  So if you want to compare multiple sections of code in a program, you'd probably create a
 *  an array of run_time objects and an array of corresponding ints to store average run times.
